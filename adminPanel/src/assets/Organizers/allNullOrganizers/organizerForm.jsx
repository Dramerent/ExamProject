...
export function OrganizerForm({el}){
    const {setBigPhoto, err, setErr, setPhotoURL,isRetText, setIsRetText, reasonText, setReasontext, setAllOrganizers,sendFalse, successProfile, fun1} = useContext(Context)
    ...
    return(
         <div className = "organizer" key = {el.organizer_nickname}>
            ...
            <div className="buttons-group">
                <button type="button" onClick={() =>{sendTrue(el.organizer_id)}}>подтвердить</button>
                <button onClick={() =>{
                    setIsRetText(!isRetText)
